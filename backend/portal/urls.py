...
urlpatterns = [
    ...
    path("crear_solicitud/", SolicitudArriedoCreateView.as_view(), name="solicitud_create"),
    path("actualizar_solicitud/<int:pk>/", SolicitudArriendoUpdateView.as_view(), name="solicitud_create"),
